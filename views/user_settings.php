		...
		<?php } else { ?>
			...
			<div class="row">
				<?php 
					...
					?><br>
				<input type="button" value=<?php echo '"'.TXT_MODIF_MAIL.'"'; ?> onclick="hideThis('form1')" />	
				...
				<form  id="form1" class="hide_first" action="" method="POST">		
					...
					<input type="submit" name="set_new_mail_form" value=<?php echo '"'.TXT_CONFIRMER.'"'; ?>>	
				</form>	 
			</div>			
			...
			<div class="row">
				...
				<input type="button" value=<?php echo '"'.TXT_MODIF_MDP.'"'; ?> onclick="hideThis('form2')" />
				...
				<form  id="form2" class="hide_first" action="" method="POST">
					...
					<input type="submit" name="set_new_password_form" value=<?php echo '"'.TXT_CONFIRMER.'"'; ?>>		
				</form>
			</div>	
			<br>
