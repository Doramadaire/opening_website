...
<html>
    <head>
        ...
        <meta name="description" content="<?php echo META_DESCRIPTION_USER_SETTINGS; ?>">
        <meta name="keywords" content="<?php echo META_KEYWORDS_USER_SETTINGS; ?>">
        <title><?php echo TXT_TAB_USER_SETTINGS; ?></title>
